  ...
  return (
    ...
    >
      ...
      <main className="w-full pt-16">
        <div
          className={`mx-auto min-h-[calc(100dvh-4rem)] w-full sm:p-4 ${
            isDark
              ? "sm:bg-[#070707]"
              : "sm:bg-[#f5f7fa]"
          }`}
        >
          <div
            className={`mx-auto flex min-h-[calc(100dvh-5rem)] w-full max-w-[1500px] flex-col overflow-hidden sm:rounded-2xl sm:border sm:shadow-2xl md:flex-row ${
              isDark
          ...
          >
            ...
            <aside
              className={`w-full shrink-0 border-b p-4 md:w-[280px] md:border-b-0 md:border-r md:p-5 ${
                isDark
                  ? "border-white/[0.08]"
                  : "border-black/[0.08]"
              }`}
              ...
              <div className="flex gap-2 overflow-x-auto md:grid md:gap-2">
                {([
                  ...
                  <button
                    ...
                    type="button"
                    onClick={() => setTab(key)}
                    className={`flex shrink-0 items-center justify-between gap-3 rounded-xl border px-4 py-3 text-left text-xs font-medium transition-all active:scale-[0.99] md:w-full ${
                      tab === key
                        ? isDark
                          ? "border-white/[0.12] bg-white/[0.08] text-white shadow-sm"
                          : "border-black/[0.10] bg-black/[0.04] text-black shadow-sm"
                        : isDark
                          ? "border-white/[0.06] bg-transparent text-white/60 hover:bg-white/[0.04] hover:text-white"
                          : "border-black/[0.06] bg-transparent text-black/60 hover:bg-black/[0.03] hover:text-black"
                    }`}
                  >
              ...
              <div className="mx-auto w-full max-w-4xl">
                ...
                {tab === "search" && (
                  <div className="space-y-5">
                    ...
                    {!trimmedSearch ? (
                      <div
                        className={`flex min-h-[260px] flex-col items-center justify-center rounded-2xl border text-center ${
                          isDark
                      ...
                      >
                        ...
                        >
                          Search by username to find and
                              ...
                              <div className="flex flex-wrap items-center gap-2">
                                ...
                                {user.relationship ===
                                  ...
                                  <button
                                    ...
                                    className={`rounded-lg px-4 py-2 text-xs font-semibold transition-all active:scale-[0.97] disabled:cursor-not-allowed disabled:opacity-50 ${
                                      isDark
                                ...
                                {user.relationship ===
                                  ...
                                  <>
                                    <button
                                      ...
                                      className="rounded-lg bg-emerald-500 px-4 py-2 text-xs font-semibold text-white transition-all hover:bg-emerald-600 active:scale-[0.97] disabled:cursor-not-allowed disabled:opacity-50"
                                    >
                                      {busy
                                        ? "Accepting..."
                                        : "Accept"}
                                    ...
                                    <button
                                      ...
                                      className={`rounded-lg border px-4 py-2 text-xs font-medium transition-all active:scale-[0.97] disabled:cursor-not-allowed disabled:opacity-50 ${
                                        isDark
